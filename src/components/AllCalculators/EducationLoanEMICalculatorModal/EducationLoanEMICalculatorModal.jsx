        ...
        <div className={styles.modalBody}>
          <div className={styles.inputSection}>
            ...
            <label>
              ...
              <input type="number" min={1} max={10} value={courseDuration} onChange={(e) => setCourseDuration(+e.target.value)} />
            </label>
            ...
            {result ? (
              <>
                ...
                <p className={styles.note}>
                  Your EMI will be {formatCurrency(result.EMI)} post course completion for a loan of {formatCurrency(result.loanAmount)} at {interestRate}% p.a.
                </p>
              </>
            ) : (
              <div className={styles.placeholder}>
                ...
                <p>Calculate EMI post moratorium with interest accrual.</p>
              </div>
            )}
          </div>
        </div>
