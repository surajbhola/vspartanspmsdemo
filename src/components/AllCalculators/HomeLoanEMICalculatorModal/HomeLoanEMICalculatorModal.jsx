...
import styles from "./HomeLoanEMICalculatorModal.module.css";

const HomeLoanEMICalculatorModal = ({ onClose }) => {
    ...
    <div className={styles.overlay} role="dialog" aria-modal="true" aria-labelledby="modal-title">
      <div className={styles.modal} ref={modalRef} tabIndex={-1}>
        <header className={styles.header}>
          <h2 id="modal-title">Home Loan EMI Calculator</h2>
...
export default HomeLoanEMICalculatorModal;
