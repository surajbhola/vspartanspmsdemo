        ...
        <div className={styles.modalBody}>
          <div className={styles.inputSection}>
            ...
            <p className={styles.tip}>
              Plan your loan repayments efficiently with this EMI estimator.
            </p>
          </div>
            ...
            {result ? (
              <>
                ...
                <p className={styles.note}>
                  Your monthly EMI will be <strong>{formatCurrency(result.EMI)}</strong> for a loan of{" "}
              ...
              <div className={styles.placeholder}>
                ...
                <p>Enter loan amount, interest rate, and tenure to estimate monthly repayments.</p>
              </div>
            )}
          </div>
        </div>
